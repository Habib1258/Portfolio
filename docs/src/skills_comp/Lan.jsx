        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
          <div className=' mr-12 border-2 border-lime-400 rounded-2xl'>
            ...
            <div className='bg-slate-200 w-40 lg:w-2/3 rounded-3xl ml-6 lg:ml-12'>
              <div className='bg-lime-400 h-3 w-full rounded-3xl mb-6 animate-growWidthMaxed'>
          ...
          <div className=' mr-12 border-2 border-lime-400 rounded-2xl'>
            ...
            <div className='bg-slate-200 w-40 lg:w-2/3 rounded-3xl ml-6 lg:ml-12'>
              <div className='bg-lime-400 h-3 w-1/6 rounded-3xl mb-6 animate-growWidthlowest'>
