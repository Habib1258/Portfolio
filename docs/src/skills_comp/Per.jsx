...
const Per = () => {
  return (
      <>
        <section className='bg-custom-dark text-white pb-36 pl-10 lg:pl-48 place-content-center 2xl:px-[700px]'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3  gap-6'>
          ...
          <div className='grid grid-cols-1'>
            ...
            <div className=' mr-12 rounded-2xl'>
                  ...
                  <h1 className='text-lg lg:text-2xl text-slate-300 px-10  rounded font-bold'> React Native</h1>
                </div>
          </div>
        </div>
      </section>
