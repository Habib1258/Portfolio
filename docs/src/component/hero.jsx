...
const Hero = () => {
  return (
    <>
        <section className=' bg-black drop-shadow-2xl flex h-1/2 2xl:pl-[200px] place-content-center w-full mx-auto overflow-x-hidden px-auto'>
          <div id="home" className='grid grid-cols-1 lg:flex h-1/2 w-full'>
          ...
          <div className='w-18 h-24 lg:w-72 lg:h-72  bg-gradient-to-r from-white to-lime-400 shadow-xl shadow-indigo-500 rounded-full rotate-12 z-0 absolute top-64 right-24 lg:top-28 lg:right-64 2xl:top-40 2xl:right-[900px] opacity-70 lg:opacity-10 blur-3xl'>
